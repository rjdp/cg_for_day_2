...
terraform {
  ...
  backend "remote" {
    ...
    workspaces {
      name = "kubernetes-ops-production-helm-kube-prometheus-stack"
    }
  }
}
...
module "kube-prometheus-stack" {
  source = "github.com/ManagedKube/kubernetes-ops//terraform-modules/aws/helm/kube-prometheus-stack?ref=v2.0.19"
